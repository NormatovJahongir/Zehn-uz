...
import { usePathname } from 'next/navigation'; // Hook qo'shildi
import { 
...
export default function RootLayout({
  ...
  // Agarda sahifa /center/ bilan boshlansa, bu admin paneli hisoblanadi
  const isAdminPage = pathname.startsWith('/center/');

  // Kelajakda auth mantiqi shu yerda bo'ladi
  ...
  return (
    <html lang="uz">
      ...
      <body className={`${inter.className} min-h-screen flex flex-col bg-gray-50 text-gray-900 antialiased`}>
        ...
        {/* Navigation - Faqat admin sahifasi bo'lmasa ko'rinadi */}
        {!isAdminPage && (
        ...
        {/* Footer - Faqat admin sahifasi bo'lmasa ko'rinadi */}
        {!isAdminPage && (
